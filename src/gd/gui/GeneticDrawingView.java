...
import cifo.searchMethods.GeneticAlgorithm;
import cifo.searchMethods.HillClimber;
import cifo.searchMethods.RandomSearch;
import cifo.searchMethods.SearchMethod;
...
public class GeneticDrawingView extends FrameView {
	...
	public void startEvolution() throws InvalidConfigurationException {
		...
		if (isEvolutionActivated == false) {
			...
			// change here if a new search method is to be added
			SearchMethod searchMethod;
			if (Main.SEARCH_METHOD == SearchMethods.GA) {
				searchMethod = new GeneticAlgorithm();
			} else if (Main.SEARCH_METHOD == SearchMethods.HC) {
				searchMethod = new HillClimber();
			} else {
				searchMethod = new RandomSearch();
			}
