...
public class Main {
	...
	public static final SearchMethods SEARCH_METHOD = SearchMethods.GA;
	// public static final SearchMethods SEARCH_METHOD = SearchMethods.HC;
	// public static final SearchMethods SEARCH_METHOD = SearchMethods.RS;
